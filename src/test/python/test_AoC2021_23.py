...
import unittest
import AoC2021_23
from AoC2021_23 import Diagram, Room


class ParseTest(unittest.TestCase):
    def test(self):
        diagram = AoC2021_23._parse(("#############",
                                     "#...........#",
                                     "###B#C#B#D###",
                                     "  #D#C#B#A#",
                                     "  #D#B#A#C#",
...
class DiagramTest(unittest.TestCase):
    ...
    def test_moves_to_hallway(self):
        diagram = AoC2021_23._parse(("#############",
                                     "#.....D.....#",
                                     "###C#B#.#C###",
                                     "  #A#B#D#A#",
        ...
        self.assertEqual(
            ...
            {("room_a", 1, 0), ("room_a", 1, 1), ("room_a", 1, 3),
             ("room_c", 0, 7), ("room_c", 0, 9), ("room_c", 0, 10),
             ("room_d", 1, 7), ("room_d", 1, 9), ("room_d", 1, 10),
             })

    def test_energy_for_move(self):
        diagram = AoC2021_23._parse(("#############",
                                     "#.....D.....#",
                                     "###C#B#.#A###",
                                     "  #A#B#D#C#",
                                     "  #########"))
        self.assertEqual(diagram.energy_for_move_to_hallway(("room_a", 1, 0)),
                         300)
        self.assertEqual(diagram.energy_for_move_to_hallway(("room_a", 1, 1)),
                         200)
        self.assertEqual(diagram.energy_for_move_to_hallway(("room_a", 1, 3)),
                         200)
        self.assertEqual(diagram.energy_for_move_to_hallway(("room_c", 0, 7)),
                         3_000)
        self.assertEqual(diagram.energy_for_move_to_hallway(("room_c", 0, 9)),
                         5_000)
        self.assertEqual(diagram.energy_for_move_to_hallway(("room_c", 0, 10)),
                         6_000)
        self.assertEqual(diagram.energy_for_move_to_hallway(("room_d", 1, 7)),
                         2)
        self.assertEqual(diagram.energy_for_move_to_hallway(("room_d", 1, 9)),
                         2)
        self.assertEqual(diagram.energy_for_move_to_hallway(("room_d", 1, 10)),
                         3)
    ...
    def test_moves_from_hallway(self):
        diagram = AoC2021_23._parse(("#############",
                                     "#B..A.C...DC#",
                                     "###.#.#.#.###",
                                     "  #A#B#D#.#",
                                     "  #########"))
        self.assertEqual(
            diagram.moves_from_hallway(),
            {("room_a", 3, 1), ("room_d", 9, 0)})

    def test_energy_for_move_from_hallway(self):
        diagram = AoC2021_23._parse(("#############",
                                     "#B..A.C...DC#",
                                     "###.#.#.#.###",
                                     "  #A#B#D#.#",
    ...
    def test_do_move_from_hallway(self):
        diagram = AoC2021_23._parse(("#############",
                                     "#B..A.C...DC#",
                                     "###.#.#.#.###",
                                     "  #A#B#D#.#",
    ...
    def test_do_move_to_hallway(self):
        diagram = AoC2021_23._parse(("#############",
                                     "#.....D.....#",
                                     "###C#B#.#C###",
                                     "  #A#B#D#A#",
